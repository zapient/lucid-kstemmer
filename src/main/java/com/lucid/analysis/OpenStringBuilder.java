...
// Partially adapted from CharArr (in Noggit). License not inherited since
// I (YCS) was 100% author of the other code.
 ...
 */
class OpenStringBuilder implements Appendable, CharSequence {
  protected char[] buf;
  protected int len;
